...
export default function Home() {
  ...
  return <>
    <Container className="mb-12 mt-28 sm:mt-40 flex-col-center text-center">
      <div className="mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50">
        <p className="text-sm font-semibold text-gray-700">Doclyse is live!</p>
      ...
      <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg mx-auto">
        Doclyse allows you to have conversations with any PDF Document. Simply upload your file and start asking questions right away
      </p>
      <Link className={buttonVariants({
        size : "lg",
        className : "mt-5"
      })} target="_blank" href={'/dashboard'}>
